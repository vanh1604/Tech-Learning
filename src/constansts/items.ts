...
export const quizzes = [
  ...
  {
    title:
      "Trong Scratch, các khối lệnh được ghép nối lại với nhau bằng cách nào?",
    ans: [
      {
        answer: "A",
        title: "Kéo và thả",
  ...
  {
    title:
      "Khối lệnh nào được sử dụng để di chuyển một nhân vật trong Scratch?",
    ans: [
      {
        answer: "A",
        title: "Chuyển động",
...
export const quizzes2 = [
  ...
  {
    title:
      "Khi bạn muốn vật thể di chuyển đến một vị trí cụ thể trên sân chơi trong Scratch, bạn sử dụng khối lệnh nào?",
    ans: [
      {
        answer: "A",
        title: "Chuyển đến",
  ...
  {
    title:
      "Trong Scratch, để làm cho một vật thể bắt đầu quay khi bạn nhấn vào nó, bạn sử dụng khối lệnh nào?",
    ans: [
      {
        answer: "A",
...
export const lessons: CardProps[] = [
  {
    ...
    paramList: {
      id: `lesson0`,
      videoSource:
        "https://www.youtube.com/watch?v=5KoOAng2-kg&list=RDKDThNBO0vgw&index=2",
    },
    avata: {
